...
- [ ] write test for all of the objects 



- [ ] rspec ./spec/models/donation_spec.rb:11 # Donation should have one user
- [ ] rspec ./spec/models/nonprofit_spec.rb:9 # Nonprofit should have many users
